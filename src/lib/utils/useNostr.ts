...
export const useNostr = () => {
  ...
  // Aliases
  const standardizeId = standardizeValue
  ...
  const sendEventToNostrNetwork = async (
    ...
    const nostrEventSigned =
      spasm.extractSignedNostrEvent(spasmEvent) as NostrSpasmEventSignedOpened | null
