<script lang="ts">
  // MIT-licensed Heroicons (https://heroicons.dev)
  let { class: className = '' }: { class?: string } = $props();
</script>

<!-- Icon: Moon -->
<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class={className}>
